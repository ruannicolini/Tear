inherited F01010: TF01010
    ...
    inherited TbDados: TTabSheet
      ...
      inherited grDados: TGroupBox
        ...
        object DBEditBeleza1: TDBEditBeleza
          ...
          mostrar_Botao = True
          sql.Strings = (
            'select idgrupo, descricao '
            'from grupo where descricao'
            'like :varDescricao')
          database = 'balay'
          campo = 'descricao'
  ...
  object Query_TR: TFDQuery
    ...
    SQL.Strings = (
      ...
      'on otr.idTipoRecurso = t.idtipo_recurso '
      'where otr.idoperador =:id;')
    Left = 624
    Top = 232
    ParamData = <
      item
    ...
    object Query_TRidOperador: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'idOperador'
      Origin = 'idOperador'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object Query_TRidTipoRecurso: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'idTipoRecurso'
      Origin = 'idTipoRecurso'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object Query_TRidtipo_recurso: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'idtipo_recurso'
    ...
    object Query_TRdescricao: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'descricao'
      Origin = 'descricao'
      ProviderFlags = []
  ...
  object CDS_TR: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'Provider_TR'
    AfterPost = CDS_TRAfterPost
    AfterCancel = CDS_TRAfterCancel
    AfterDelete = CDS_TRAfterDelete
    Left = 696
    Top = 232
    object CDS_TRidtipo_recurso: TIntegerField
      FieldName = 'idtipo_recurso'
      ProviderFlags = [pfInUpdate]
      ReadOnly = True
    end
    object CDS_TRdescricao: TStringField
      FieldName = 'descricao'
      ProviderFlags = []
      ReadOnly = True
      Size = 45
    end
    object CDS_TRidOperador: TIntegerField
      FieldName = 'idOperador'
    end
    object CDS_TRidTipoRecurso: TIntegerField
      FieldName = 'idTipoRecurso'
    end
  end
  object Provider_TR: TDataSetProvider
    DataSet = Query_TR
    Left = 656
    Top = 232
  end
